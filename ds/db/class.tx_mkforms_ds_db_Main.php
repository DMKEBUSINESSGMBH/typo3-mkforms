...
class tx_mkforms_ds_db_Main extends formidable_maindatasource {
	...
	if (defined("TYPO3_MODE") && $TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/mkforms/ds/db/class.tx_mkforms_ds_db_Main.php"])	{
		include_once($TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/mkforms/ds/db/class.tx_mkforms_ds_db_Main.php"]);
	}
?>
