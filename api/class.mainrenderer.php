...
TEMPLATE;
                ...
                if (Tx_Rnbase_Utility_T3General::isFirstPartOfStr($sParam, 'rowData::')) {
                    ...
                    foreach ($names as $name) {
                        ...
                        if ($widget
                            ...
                            $aParams[] = 'rowInput::' . $sAs . '::' . $widget->_getElementHtmlId(
                                /*def*/
                                false, /*def*/
    ...
    function _getClientEvent($sObjectId, $aEvent = array(), $aEventData, $sEvent)
    {
        ...
        return "Formidable.f('" . $this->getForm()->getFormId() . "').executeClientEvent('" . $sObjectId . "', " . (($bPersist)
            ? "true" : "false") . ", {$sData}, '" . $sEvent . "', arguments, " . $sConfirm . ");";
    }
