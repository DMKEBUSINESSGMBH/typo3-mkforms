...
class tx_mkforms_validator_num_Main extends formidable_mainvalidator {
	...
	if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mkforms/util/validator/class.tx_mkforms_util_validator_num_Main.php'])	{
		include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mkforms/util/validator/class.tx_mkforms_util_validator_num_Main.php']);
	}
?>