...
jQuery.extend(jQuery.fn,{delayedObserver:function(a,b,c){return this.each(function(){var d=jQuery(this),e=c||{};d.data("oldval",d.val()).data("delay",b||0.5).data("condition",e.condition||function(){return jQuery(this).data("oldval")==jQuery(this).val()}).data("callback",a)[e.event||"keyup"](function(){d.data("condition").apply(d)||(d.data("timer")&&clearTimeout(d.data("timer")),d.data("timer",setTimeout(function(){d.data("callback").apply(d)},1E3*d.data("delay"))),d.data("oldval",d.val()))})})}});
...
h.bind("change.errorhandler",function(){var a=b.o(jQuery(this).attr("id")),c=MKWrapper.$("showspan_"+a.config.id,!1),a=MKWrapper.$(a.getLabel(),!1);jQuery(this).removeClass("hasError");a&&a.removeClass("hasError");c&&c.addClass("hasError")}))}}c&&jQuery(d).children().length&&c.append(d)}};MKWrapper._changeHandler=function(){jQuery(this).removeClass("hasError")};MKWrapper.filter=function(a,b){return jQuery(a).filter(function(a,d){return b(d)})};
