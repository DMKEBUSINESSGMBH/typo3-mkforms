...
e[0],oContext.event&&(oContext.event[0]=oContext.event),this.aContextStack.push(oContext),this.aParamsStack.push(c),b[a.method](oData),this.aParamsStack.pop(),this.aContextStack.pop()):console.log("executeClientEvent: single task: No method named "+a.method+" on "+a.object):console.log("executeClientEvent: single task: No object named "+a.object)},executeAjaxEvent:function(a,b,c,d,e,f,g,k,m,q,r){var s=this;if(bThrow=!1!=r?confirm(unescape(r)):!0){if(g&&"object"==typeof tinymce){if("string"==typeof g&&
"true"===g.toLowerCase())var p=tinyMCE.EditorManager.get();else p=[],MKWrapper.each(tinyMCE.explode(g,","),function(a,b){s.o(a)&&p.push(tinyMCE.EditorManager.get(s.o(a).config.id))});MKWrapper.each(p,function(a,b){try{a.save()}catch(c){}})}g={};if(k)for(var l in k)sId=sReturnName=h=k[l],"rowInput::"==h.slice(0,10)&&(aInfo=h.split("::"),sReturnName=aInfo[1],sId=aInfo[2]),h.indexOf("::")&&"rowInput::"!=h.slice(0,10)?(aInfo=h.split("::"),l=aInfo[0],h=aInfo[1],g[l]=h):(oElement=this.o(sId))?g[sReturnName]=
oElement.getParamsForMajix(oElement.getValue(),a,k,m,q):(oElement=MKWrapper.$(this.rdtIdByName(h)))?g[sReturnName]=MKWrapper.$F(oElement):g[l]=h;if(m)for(var h in m)g[h]=m[h];l=this.o(b);void 0!=l.getMajixThrowerIdentity&&(b=l.getMajixThrowerIdentity(b),g=l.getParamsForMajix(g,a,k,m,q));a=JSONstring.make(g,!0);k=!1;this.currentTriggeredArguments&&(k=JSONstring.make(this.currentTriggeredArguments,!0));var n=this.Misc.Urls.Ajax.event+"&formid="+this.sFormId+"&eventid="+c+"&safelock="+d+"&value="+escape(a)+
"&thrower="+escape(b)+"&trueargs="+escape(k);e||(n+="&random="+escape(Math.random()));e&&void 0!=this.ajaxCache[n]?this.executeAjaxResponse(this.ajaxCache[n],f,bFromCache=!0):(this.displayLoader(),MKWrapper.ajaxCall(this.Misc.Urls.Ajax.event,{method:"post",asynchronous:!0,evalJS:!0,parameters:{formid:this.sFormId,eventid:c,safelock:d,value:a,thrower:b,trueargs:k},onSuccess:function(a,b){a=MKWrapper.strStrip(a);b="undefined"!=typeof b?b:this;var c=!0;if(MKWrapper.isJSON(a))if(eval("var oJson="+a+";"),
e&&(b.ajaxCache[n]=oJson),b.executeAjaxResponse(oJson,f,bFromCache=!1),"undefined"!=typeof oJson.tasks.object&&oJson.tasks.object){if("triggerSubmit"==oJson.tasks.method||"sendToPage"==oJson.tasks.method)c=!1}else MKWrapper.each(Formidable.objValues(oJson.tasks),function(a,b){if("triggerSubmit"==a.method||"sendToPage"==a.method)c=!1});else"null"!=a&&Formidable.debugMessage(a);c?b.removeLoader():window.setTimeout(function(){b.removeLoader()},1E4)},onFailure:function(){console.log("Ajax request failed")}},
