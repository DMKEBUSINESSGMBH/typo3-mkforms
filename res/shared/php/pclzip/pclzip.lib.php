    ...
    public function privFileDescrExpand(&$p_filedescr_list, &$p_options)
    {
        ...
        for ($i = 0; $i < sizeof($p_filedescr_list); $i++) {
            ...
            elseif (isset($v_descr['content'])) {
                ...
                self::privErrorLog(PCLZIP_ERR_MISSING_FILE, "File '".$v_descr['filename']."' does not exists");
        ...
        for ($j = 0; ($j < sizeof($p_filedescr_list)) && ($v_result == 1); $j++) {
            ...
            if (($p_filedescr_list[$j]['type'] != 'virtual_file')
              && (!file_exists($p_filedescr_list[$j]['filename']))) {
                ...
                self::privErrorLog(PCLZIP_ERR_MISSING_FILE, "File '".$p_filedescr_list[$j]['filename']."' does not exists");
                //--(MAGIC-PclTrace)--//PclTraceFctEnd(__FILE__, __LINE__, PclZip::errorCode(), PclZip::errorInfo());
                return self::errorCode();
            }
