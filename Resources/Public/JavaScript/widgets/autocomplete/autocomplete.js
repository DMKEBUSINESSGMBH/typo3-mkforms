Formidable.Classes.Autocomplete = Formidable.Classes.RdtBaseClass.extend({
	...
	initStartPosition: function() {
		...
		MKWrapper.setStyle(this.oLoader, {'display':'block', 'height': '16px','width':'16px','background': 'transparent url('+Formidable.path+'Resources/Public/Images/loader.gif) no-repeat scroll 0 0'});
