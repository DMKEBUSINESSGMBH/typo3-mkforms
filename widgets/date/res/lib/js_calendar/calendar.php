...
class DHTML_Calendar {
	...
	if (defined("TYPO3_MODE") && $TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/ameos_formidable/api/base/rdt_date/res/lib/js_calendar/calendar.php"])	{
		include_once($TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/ameos_formidable/api/base/rdt_date/res/lib/js_calendar/calendar.php"]);
	}
