...
MKWrapper.attachEvent(MKWrapper.$(a),"click",function(a,b){this.setActiveTab(b.substring(1))},this)}}.bind(this))}},addTab:function(a){this.links.push(a);var b=a.getAttribute("href").split("#");a.key=b[b.length-1];this.containers[a.key]=MKWrapper.$(a.key);a[this.options.hover?"onmouseover":"onclick"]=function(a){window.event&&Event.stop(window.event);this.setActiveTab(a);return!1}.bind(this,a)},setActiveTab:function(a){a&&("string"==typeof a?MKWrapper.each(this.links,function(b){if(b.key==a)return this.setActiveTab(b),
!1}.bind(this)):(this.notify("beforeChange",this.activeContainer),this.activeContainer&&this.options.hideFunction(this.activeContainer),MKWrapper.each(this.links,function(a){MKWrapper.removeClass(this.options.setClassOnContainer?MKWrapper.$(a.parentNode):a,this.options.activeClassName)}.bind(this)),MKWrapper.addClass(this.options.setClassOnContainer?MKWrapper.$(a.parentNode):a,this.options.activeClassName),this.activeContainer=this.containers[a.key],this.activeLink=a,this.options.showFunction(this.containers[a.key]),
this.notify("afterChange",this.containers[a.key])))},next:function(){var a=!1;MKWrapper.each(this.links,function(b,c){this.activeLink==b&&this.links[c+1]&&(a=this.links[c+1])}.bind(this));this.setActiveTab(a);return!1},previous:function(){MKWrapper.each(this.links,function(a,b){this.activeLink==a&&this.links[b-1]&&this.setActiveTab(this.links[b-1])}.bind(this));return!1},first:function(){this.setActiveTab(this.links.first());return!1},last:function(){this.setActiveTab(this.links.last());return!1},
notify:function(a){try{if(this.options[a])return[this.options[a].apply(this.options[a],arguments.slice(1))]}catch(b){return!1}}});MKWrapper.extend(Control.Tabs,{instances:[],findByTabId:function(a){return Control.Tabs.instances.find(function(b){return b.links.find(function(b){return b.key==a})})}});